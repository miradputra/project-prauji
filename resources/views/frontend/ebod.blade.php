                ...
                <div class="col-lg-4 col-md-6">
                  <div class="single-product">
                    <div class="product-img">
                      <img
                        class="card-img"
                        src="frontend/eiser/img/product/inspired-product/ebodvit.jpg"alt="" style = "height:250px;"/>
                      <div class="p_icon">
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="single-product">
                    <div class="product-img">
                      <img
                        class="card-img"
                        src="frontend/eiser/img/product/inspired-product/obat3.png"alt="" style = "height:250px;"/>
                      <div class="p_icon">
                        <a href="single-product">
                          <i class="ti-shopping-cart"></i>
                        </a>
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="single-product">
                    <div class="product-img">
                      <img
                        class="card-img"
                        src="frontend/eiser/img/product/inspired-product/obat2.jpg" alt="" style = "height:250px;"/>
                      <div class="p_icon">
                      <a href="single-product">
                          <i class="ti-shopping-cart"></i>
                        </a>

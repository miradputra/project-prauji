    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="single-product">
            <div class="product-img">
              <img class="img-fluid w-100" src="frontend/eiser/img/product/feature-product/obat1.jpeg" alt="" style = "height:250px;" />
              <div class="p_icon">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="single-product">
            <div class="product-img">
              <img class="img-fluid w-100" src="frontend/eiser/img/product/feature-product/obat2.jpg" alt="" style = "height:250px;" />
              <div class="p_icon">
                <a href="#">
                  <i class="ti-eye"></i>
                </a>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="single-product">
            <div class="product-img">
              <img class="img-fluid w-100" src="frontend/eiser/img/product/feature-product/obat3.png" alt="" style = "height:250px;" />
              <div class="p_icon">
                <a href="#">
                  <i class="ti-eye"></i>
                </a>
